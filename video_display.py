# -*- coding: utf-8 -*-
"""
Created on Wed Oct 26 20:24:45 2022
        ...
        while True:  # Main event Loop
            ...
            if event == "Browse":
                ...
                if video_path:
                    ...
                    #height, width, channels = self.vid.shape
                    blob = cv2.dnn.blobFromImage(self.vid, 0.00392, (416, 416), (0, 0, 0), True, crop=False)
